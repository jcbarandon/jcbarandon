...
# ===========================================================================
HOST = "joe"   # shown as  joe@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Jr. Applications Dev @ Ateneo de Naga"),
    ("kv", "Intern", "ML Engineering Intern @ FlyRank AI"),
    ("kv", "Also", "Tagalog Writing Consultant @ Outlier"),
    ("kv", "Edu", "BS Computer Science, Ateneo de Naga"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Langs", "Python, Java, JS, C/C++, C#, PHP"),
    ("kv", "Web", "React, Node, Express, Bootstrap"),
    ("kv", "Data", "MongoDB, Azure, REST APIs"),
    ("kv", "Tools", "Git, Linux, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "National Finalist - DOST Level Up 2.0"),
    ("bul", "1st Place - AdNU Software Festival 2025"),
    ("bul", "Academic Honors - QPI 3.79 / he-him"),
]
